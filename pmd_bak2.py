...
class Pmd():
    ...
    def __init__(self,repo_id,time_logger):
        ...
        self.java_tmp = self.BASIC_PATH + 'cas_test/tmp/tmp_' + repo_id + '.java'
        self.xml_tmp = './tmp/tmp_' + repo_id + '.xml'
        self.cache_tmp = './tmp/cache_' + repo_id
        self.repo_dir = self.BASIC_PATH + 'cas_vlis/ingester/CASRepos/git/' + repo_id
        self.test_csv = self.BASIC_PATH + 'testset/' +repo_id+'_test'
        # init log
